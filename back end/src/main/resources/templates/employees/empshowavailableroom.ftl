                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                ...
                                <p class="category"><h5>This is our available room, you can choose one from this list.</h5></p>
                            </div>
                            <br/><br/>
            ...
            <div class="modal-body">
                <form class="form-horizontal" ng-submit="ctrlBooking.submit()" name="myForm">
                    ...
                    <div class="form-group modal-footer">
                        <input type="submit" data-dismiss="modal" value="Book" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid || myForm.$pristine">
                    </div>
                </form>
