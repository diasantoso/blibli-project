...
@EnableJpaRepositories(basePackages = {"springboot.repository", "springboot.model"})
@EnableJpaAuditing
@EnableTransactionManagement
@ComponentScan(basePackages = {"springboot.repository", "springboot.model"})
public class Configuration {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
        ...
        entityManagerFactory.setPackagesToScan("springboot.model","springboot.repository");
